/*
    ...
    5. 형식
        SELECT 조회할칼럼, 조회할칼럼, ...
         ...
         GROUP BY 그룹화할칼럼,...
        HAVING 그룹조건식  GROUP BY 랑 HAVING은 같이들어가야함
...
SELECT  *
FROM    DEPARTMENT_T
WHERE   LOCATION = '서울'; --LOCATION 칼럼은 UNIQUE하지 않기 떄문에 조회 결과는 2개 이상이 가능하다.
